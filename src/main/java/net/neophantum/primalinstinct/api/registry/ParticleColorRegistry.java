package net.neophantum.primalinstinct.api.registry;

import net.neophantum.primalinstinct.api.particle.IParticleProvider;
import net.neophantum.primalinstinct.client.particle.ParticleColor;
import net.neophantum.primalinstinct.client.particle.RainbowParticleColor;
...
public class ParticleColorRegistry {
    ...
    private static final ConcurrentHashMap<ResourceLocation, IParticleProvider> MAP = new ConcurrentHashMap<>();
